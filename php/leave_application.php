...
$sql = "INSERT INTO `Leaves` (`UserId`,`f_name`,`l_name`,`email`,`leave_type`,`leavestart`,`leaveenddate`,`reason`)  VALUES ('$UserId','$row[f_name]',' $row[l_name]',' $row[email]','$_POST[leave_type]','$_POST[leave_start_date]','$_POST[leave_end_date]','$_POST[reason]')";
